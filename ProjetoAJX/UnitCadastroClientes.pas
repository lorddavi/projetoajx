...
//Cancela a edição ou inserção dos ZQuerys e habilita/desabilita os botões que podem
//ser usados nesse estado.
...
//Pergunta ao usuário e, se a resposta for positiva, deleta o campo selecionado
//do ZQuery e habilita/desabilita os botões que podem ser usados nesse estado.
...
//Coloca o ZQuery em modo de edição e habilita/desabilita os botões que podem
//ser usados nesse estado.
...
//Coloca o ZQuery em modo de inserção e habilita/desabilita os botões que podem
//ser usados nesse estado.
...
//Invoca a function de validação de campos em branco e, se estiver tudo preenchido,
//salva os dados no banco e habilita/desabilita os botões que podem ser usados
//nesse estado.
procedure TFormCadastroClientes.btnSalvarClick(Sender: TObject);
begin
  if (VerificaBrancos) then
    begin
      DBGridEndereco.DataSource := DataSourceEndereco;
